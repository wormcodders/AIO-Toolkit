        ...
        <div className={topBarClass}>
          ...
          <Card title="Model">
            ...
            <SelectInput
              ...
              onChange={value => {
                if (value === '') {
                  setJobConfig(undefined, 'config.process[0].model.te_device');
                } else {
                  setJobConfig(value, 'config.process[0].model.te_device');
                }
              }}
              options={[
            ...
            <SelectInput
              ...
              onChange={value => {
                if (value === '') {
                  setJobConfig(undefined, 'config.process[0].model.vae_device');
                } else {
                  setJobConfig(value, 'config.process[0].model.vae_device');
                }
              }}
              options={[
                { label: 'Auto (Default)', value: '' },

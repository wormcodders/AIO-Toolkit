...
def get_train_sd_device_state_preset(
        ...
        te_device: Union[str, torch.device, None] = None,
        vae_device: Union[str, torch.device, None] = None,
):
    preset = copy.deepcopy(empty_preset)
    
    if te_device is None:
        te_device = device
    if vae_device is None:
        vae_device = device

    if not cached_latents:
        preset['vae']['device'] = vae_device
    ...
    if train_text_encoder:
        ...
        preset['text_encoder']['device'] = te_device
    else:
        preset['text_encoder']['device'] = te_device

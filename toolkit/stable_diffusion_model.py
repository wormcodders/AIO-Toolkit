...
class StableDiffusion:
    ...
    def __init__(
        ...
        self.vae_device_torch = torch.device(model_config.vae_device if model_config.vae_device else device)
        self.vae_torch_dtype = get_torch_dtype(model_config.vae_dtype)

        self.te_device_torch = torch.device(model_config.te_device if model_config.te_device else device)
